...
EVAL_AT_END=1 bash scripts/phase0/drive.sh scripts/phase0/dense_ext_1e16.txt
echo "=== dense_s1_1e17 (eval@iters/10) $(date) ==="
EVAL_AT_END=0 bash scripts/phase0/drive.sh scripts/phase0/dense_ext_1e17.txt
