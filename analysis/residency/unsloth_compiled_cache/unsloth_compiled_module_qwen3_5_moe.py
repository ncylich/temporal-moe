...
try:
    ...
    pass
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.qwen3_5_moe.modeling_qwen3_5_moe import (F, Callable, Any, Optional, torch, nn, init, ACT2FN, Cache, GenerationMixin, FlashAttentionKwargs, BaseModelOutputWithPooling, CausalLMOutputWithPast, MoeCausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, TransformersKwargs, can_return_tuple, deprecate_kwarg, is_flash_attention_requested, maybe_autocast, Qwen3_5MoeConfig, Qwen3_5MoeTextConfig, Qwen3_5MoeVisionConfig, causal_conv1d_fn, causal_conv1d_update, FusedRMSNormGated, chunk_gated_delta_rule, fused_recurrent_gated_delta_rule, logger, __name__, is_fast_path_available, Qwen3_5MoePreTrainedModel, Qwen3_5MoeCausalLMOutputWithPast, Qwen3_5MoeModel, Qwen3_5MoeForConditionalGeneration, Qwen3_5MoeGatedDeltaNet)

@torch.compiler.disable(recursive = False)
def Qwen3_5MoeVisionRotaryEmbedding_forward(self, position_ids: torch.Tensor) -> torch.Tensor:
...
class Qwen3_5MoeVisionRotaryEmbedding(nn.Module):
    ...
    def forward(self, position_ids: torch.Tensor) -> torch.Tensor:
        return Qwen3_5MoeVisionRotaryEmbedding_forward(self, position_ids=position_ids)
...
class Qwen3_5MoeGatedDeltaNet(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return Qwen3_5MoeGatedDeltaNet_forward(self, hidden_states=hidden_states, cache_params=cache_params, attention_mask=attention_mask, **kwargs)
...
class Qwen3_5MoeAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        return Qwen3_5MoeAttention_forward(self, hidden_states=hidden_states, position_embeddings=position_embeddings, attention_mask=attention_mask, past_key_values=past_key_values, **kwargs)
...
class Qwen3_5MoeVisionAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return Qwen3_5MoeVisionAttention_forward(self, hidden_states=hidden_states, cu_seqlens=cu_seqlens, position_embeddings=position_embeddings, **kwargs)
...
Qwen3_5MoeForConditionalGeneration.__UNSLOTH_SUPPORTS_RETURN_HIDDEN_STATES__ = True
