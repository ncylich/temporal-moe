...
def main():
    ...
    ap.add_argument("--online-max-model-len", type=int, default=2560, help="engine context for the sampler (raise for thinking rows)")
    ...
    if A.online_every:
        ...
        SAMPLER = OnlineSampler(model, A.model, A.R, 1, A.online_prompts, A.online_quota,
                                max_new=A.online_max_new, gpu_mem=A.online_gpu_mem, seed=A.data_seed, max_model_len=A.online_max_model_len,
