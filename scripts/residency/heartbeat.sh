...
echo "  OVERNIGHT 08-27: two DATA levers running -- A: StackMathQA lane x2 at fixed"
echo "  pool size; C: 3x unique prompts, math lane scaled correctly. Bar to beat: +4.5."
