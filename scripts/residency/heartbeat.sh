...
echo "  CODE -- BUDGET IS THE CONFOUND (2026-08-26). At the 1536-token cap the adapter"
echo "  shows nothing on code (HumanEval +0.0 vs base). At 8192 the adapted R8 arm"
echo "  EQUALS its free arm (97.0/97.0, gap +0.0) vs base -4.9: +4.9 +/- 2.4, z=2.00."
echo "  The adapter DOES repair code damage; constrained gens need room to finish."
echo "  Every earlier code cell (incl. all MBPP and all d7code arms) used 1536 and is"
echo "  therefore SUSPECT. Re-measure code at 8192 before concluding anything."
echo "  MBPP scoring itself is deterministic; its run-to-run sd 3.5 is real variance."
