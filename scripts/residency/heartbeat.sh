...
echo "ROUND 2 RUNNING (18:38, 767 tok/s): CE(W=3)+anchor+on-policy KL, result ~20:05. QUEUED NEXT:"
echo "  PURE variant (user 08-28 19:20: the KL prices digits in, no CE/W needed): on-policy KL +"
echo "  free anchor only, record gemma4_ce_onpolpure, ~21:30. Then the gemma deadband surfaces."
