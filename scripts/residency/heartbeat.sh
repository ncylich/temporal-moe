...
echo "DIAGNOSIS (08-27, failure_filter.py): residency breaks ARITHMETIC. Half of qwen R8"
echo "  failures contain a false equation (5+4+2=8, 30-27=7); plan/setup intact. The adapter"
