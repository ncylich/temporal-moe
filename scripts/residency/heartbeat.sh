...
echo "DIAGNOSIS (08-27, failure_filter.py): residency breaks ARITHMETIC. 84% of qwen R8 real"
echo "  failures (66% gemma) contain a false equation (5+4+2=8); plan intact. Scorer artifacts"
echo "  are a UNIFORM offset (gap unchanged under 3 extractors) -- damage is real. The adapter"
...
echo "  '=' = 0.66%: the loss cannot see the failure. FIX RUNNING: --digit-weight 10 on"
