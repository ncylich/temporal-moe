...
export TEMPORAL_EAGER=1 PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True CUDA_VISIBLE_DEVICES=0
...
[ -s /tmp/claude-0/-workspace-temporal-moe/c5a8032b-6316-4ce6-b1ab-aa68b4e2178a/scratchpad/ref_digit3_eager.json ] || $L $PY -u analysis/residency/parity_vllm.py --path /root/models/gemma4-digit3-merged --R 8 --n 8 --max-new 256 --out /tmp/claude-0/-workspace-temporal-moe/c5a8032b-6316-4ce6-b1ab-aa68b4e2178a/scratchpad/ref_digit3_eager.json
...
$L $PY -u analysis/residency/train_gemma_ce.py --model /dev/shm/gemma4-26b-it --family gemma4 --no-unsloth --traj gemma4_d7_seq4096 --max-seq 4096 \
  ...
  --online-every 16 --online-n 32 --online-smoke /tmp/claude-0/-workspace-temporal-moe/c5a8032b-6316-4ce6-b1ab-aa68b4e2178a/scratchpad/ref_digit3_eager.json
