...
# swap cu129 -> cu130 so the env matches results/ablations/unsloth_parity.md exactly
$P -m pip install torch==2.13.0 torchvision==0.28.0 torchaudio==2.11.0 --index-url https://download.pytorch.org/whl/cu130
$P - <<'PY'
import unsloth, unsloth_zoo, torch, transformers
print("torch", torch.__version__, "| built for CUDA", torch.version.cuda)
print("transformers", transformers.__version__, "| unsloth", unsloth.__version__, "| zoo", unsloth_zoo.__version__)
