...
cell min_logit 2 6 scripts/phase0/temporal_minlogit_sh1_1e17.txt   # 1 shared, K=6
cell min_logit 3 5 scripts/phase0/temporal_minlogit_sh2_1e17.txt   # 2 shared, K=5
