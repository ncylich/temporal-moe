...
reused from the A6000 baseline (4.137; same corpus/tokenizer, cross-data <~0.01 nats). Paper MoE law = ref.
...
# worst -> best CE (left -> right)
labels = ["dense\nbaseline", "full MoE\nfine (18 of 192)", "temporal\nfine (18 of 192)",
          "full MoE\ncoarse (6 of 64)", "full MoE\n(paper law)"]
ce     = [4.137, 4.0087, 3.9768, 3.9209, 3.78]
colors = ["C3", "C0", "C2", "C0", "C0"]
...
bars[4].set_hatch("//"); bars[4].set_alpha(0.45)        # paper law estimate, not measured here
...
fig.text(0.5, 0.005,
         ...
         "'dense baseline' = plain feed-forward. Faded blue = fine-grained full MoE; hatched = paper "
         "scaling-law estimate (not measured here).", ha="center", fontsize=7.8, wrap=True)
