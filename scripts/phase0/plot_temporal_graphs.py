#!/usr/bin/env python3
"""Temporal (rolling-residency, min_logit, 1 shared) vs the dense floor and full MoE (1 shared)
IsoFLOP curves, both budgets on a SINGLE combined axes (color = method, linestyle = budget).
All BPB measured (results/phase0/log.md); lower is better. Output: temporal_minlogit_combined.png.
"""
import numpy as np
import matplotlib
matplotlib.use("Agg")
