...
[`analysis/residency/`](../../analysis/residency/README.md) — `layer_ablation.py`, `joint_free.py`, and
...
*Generated by `analysis/residency/summary_table.py` from the per-cell JSONs and `layer_freeing_downstream.csv`. Do not edit by hand — run the script. 12 cells, 11 scored downstream.*
