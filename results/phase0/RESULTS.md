...
![Full MoE vs dense-baseline IsoFLOP curves](figures/fine_grained_vs_coarse_experts_isoflop.png)
...
The MoE advantage *widens* with size (@1e17: −0.077 at s1 → −0.119 at s3). Plot: `figures/fine_grained_vs_coarse_experts_isoflop.png`.
