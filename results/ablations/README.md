...
| `layer_freeing_results.csv` | Per-layer residency RELAXATION, a separate line of inquiry (`group`: layer_damage / free_set / trained_cell / reference). Era narrative archived: [../archive/olmoe_wrong_renorm/layer_freeing_RESULTS.md](../archive/olmoe_wrong_renorm/layer_freeing_RESULTS.md); correct-convention write-up: mechanism/01-findings.md section 5. | ple-adaptation, `analysis/residency/consolidate.py` |
| `layer_freeing_RESULTS.md` (archived) | Renorm-era closeout; every number in it is an era record and none stands. Moved to `results/archive/olmoe_wrong_renorm/`. Superseded by mechanism/01-findings.md section 5. | era record |
